...
namespace BoostPHP\MySQL{
	 ...
	 */
	function connectDB(string $Username, string $Password, string $Database, string $Host = "127.0.0.1", int $Port = 3306){
	 ...
	 */
	function selectIntoArray_FromStatement($MySQLiConn, string $SelectStatement) : array{
	 ...
	 * @returnKey result[array] - the result of the selection(only when count > 0)
	 */
	function selectIntoArray_FromRequirements($MySQLiConn, string $Table, array $SelectRequirement = array(), array $OrderByArray = array(), int $NumLimit = -1, int $OffsetNum = 0) : int{
	 ...
	 */
	function checkExist($MySQLiConn,string $Table,array $SelectRequirement) : int{
	 ...
	 */
	function insertRow($MySQLiConn, string $Table, array $InsertArray) : bool{
	 ...
	 */
	function updateRows($MySQLiConn, string $Table, array $UpdateArray, array $SelectRequirement) : bool{
	 ...
	 * @return bool - if succeed, return true.
	 */
	function deleteRows($MySQLiConn, string $Table, array $SelectRequirement) : bool{
	 ...
	 */
	function closeConn($MySQLiConn) : bool{
